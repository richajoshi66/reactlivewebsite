    ...
    const settings = {
      ...
      customPaging: i => (
        <div className="video-slider-counts">
          <span className="text">El Silencio Mezcal </span>
    ...
    return (
        <Layout>
            <section className="page-banner triangle-banner-main">
                <div className="triangle-banner brands-page"></div>
                <div className="triangle-banner-overlay"></div>
                <div className="container">
                    <div className="row">
                        <div className="col-md-6">
                            <div className=" triangle-banner-content">
                                <h1>For Brands - Reach the right audience on Primetime TV</h1>
                                <p>Brands and businesses worldwide are discovering the power of reaching new audiences through digital placements and Connected TV with Brandzooka. It’s the power of digital with the magic of programmatic built in.</p>
                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="platform-text">
                      ...
                      <h3 className="mb-3">
                        Build Brand Awareness, Audience Consideration and Drive Action
                      </h3>
                      <p className="mb-3">
                  ...
                  <div className="image-outer media-partner">
                      <div className="inner-image">
                        <img src="/images/brand-awareness-sub.png" alt="image" />
                      </div>
                      <img src="/images/brand-awareness.png" alt="image" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section className="our-platform no-line">
              <div className="container">
                <div className="row">
                    <div className="col-md-6">
                        <img src="/images/tv-image.png" alt="image" />
                    </div>
                  <div className="col-md-6">
                    <div className="platform-text mt-5 mt-md-0">
                      <h3 className="mb-3">
                        Reach the People That Matter, All Around the Globe 
                      </h3>
                      <p className="mb-3">
                          Brandzooka makes it possible for businesses of all sizes to deploy targeted and high-performing rich media across digital and TV at any budget level.   
                      </p>
            ...
            <div className="video-slider brands-page mb-5" id="reels">
                <div className="row">
                ...
                <Slider {...settings}>
                    <div>
                        <div className="position-relative">
                            <img src="/images/brand-slider.png" />
                            <div className="play-circle"><i className="fa fa-play"></i></div>
                        </div> 
                    </div>
                    <div>
            ...
            <section className="powerful-way our-platform pb-0 agencies-page brand-page">
                ...
                <div>
                    ...
                    <div className="right">
                    <div className="text-content">
                        <h3>The advertising power behind over 40,000 businesses worldwide</h3>
